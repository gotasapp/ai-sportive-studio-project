...
export default function BadgesPage() {
  ...
  // ESTADO DE BUSCA E FILTRO PARA BADGES
  ...
  return (
    <div className="space-y-8">
              ...
              <Dialog open={showUploadImageDialog} onOpenChange={setShowUploadImageDialog}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  {paginatedImages.map(img => (
                    <Card key={img.id} className="cyber-card border-gray-700"><CardContent className="p-2"><div className="relative aspect-square rounded-md overflow-hidden mb-2"><Image src={img.url} alt={img.filename} fill className="object-cover" /></div><p className="text-xs font-medium text-gray-200 truncate">{img.teamName}</p></CardContent></Card>
                  ))}
                </div>
      ...
      {/* Card de busca/filtros shadcn (agora acima do generated badges) */}
      <Card className="cyber-card border-cyan-500/30">
      ...
      {/* Card de Badges Geradas (abaixo do filtro) */}
      <Card className="cyber-card border-cyan-500/30">
        <CardHeader>
        ...
        <CardContent>
          {badgesLoading ? (
            ...
            <>
              ...
              {/* Paginação das badges criadas */}
              {badges.length > badgesPerPage && (
                <div className="flex justify-between items-center mt-4">
                  <span className="text-gray-400 text-sm">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={() => setCurrentBadgePage(currentBadgePage - 1)}
                    >
                      Previous
                    </Button>
                    <Button

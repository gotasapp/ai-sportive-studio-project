...
import { mainnet, arbitrum, polygon, polygonAmoy, type AppKitNetwork } from '@reown/appkit/networks'
...
// Supported networks
export const networks: [AppKitNetwork, ...AppKitNetwork[]] = [chzChain, mainnet, polygon, polygonAmoy, arbitrum]

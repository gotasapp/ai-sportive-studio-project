...
export function useWeb3() {
  ...
  const claimLaunchpadNFT = async (quantity: number = 1) => {
    ...
    try {
      ...
      // Prepare claim transaction using SDK helper and attach value
      ...
      const transaction: any = { ...baseTx, value: totalCost };

      console.log('✅ Transaction prepared for Launchpad claim (SDK + value)');

...
export default function JerseyEditor() {
  ...
  const supportedChainIds = [88888, 88882, 137, 80001] // CHZ + Mumbai only
  ...
  const isOnPolygonChain = chainId === 137 || chainId === 80001 // Polygon mainnet or Mumbai testnet
  ...
  // 🎯 Função de minting NFT (Simplificada)
  const handleMintNFT = async () => {
    ...
    try {
      ...
      setMintSuccess(`🎉 NFT minted successfully! Strategy: ${result.strategy || 'Unknown'}`)

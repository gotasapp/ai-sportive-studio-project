  ...
  return (
    <div className="bg-[#000000] border-b border-[#FDFDFD]/10">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative w-64">
            ...
            <Input
              ...
              className="pl-10 bg-[#000000] border-[#FDFDFD]/20 text-[#FDFDFD] placeholder:text-[#FDFDFD]/50"
            />
          </div>
          ...
          {onShowInsights && (
            <Button
              ...
              className="bg-[#000000] border-[#FDFDFD]/20 text-[#FDFDFD] hover:bg-[#FDFDFD]/10"
            >
      ...
      <div className="flex items-center gap-4 text-sm text-[#FDFDFD]/70 max-w-7xl mx-auto">
        ...
        {searchTerm && (
          <Badge variant="secondary" className="bg-[#FDFDFD]/10 text-[#FDFDFD]">
            Search: "{searchTerm}"
          </Badge>
        )}
      </div>

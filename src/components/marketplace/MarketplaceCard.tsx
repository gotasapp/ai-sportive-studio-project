  ...
  return (
    <div className="bg-card rounded-xl overflow-hidden border border-secondary/10 group transition-all hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10">
      ...
      <div className="p-4">
        ...
        <h3 className="font-bold text-lg text-white truncate my-1">{name}</h3>
        <div className="flex justify-between items-center mt-3">
          <div>
            <p className="text-xs text-secondary">Price</p>
            <p className="font-bold text-white">{price}</p>
          </div>
          <button className="bg-accent text-white px-5 py-2 rounded-lg font-semibold text-sm hover:bg-accent/90 transition-colors">
            Buy Now
          </button>
        </div>
      </div>
